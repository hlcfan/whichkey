tell application "System Events"
    ...
    set size of frontWindow to {screenWidth, screenHeight / 2}

    set position of recentWindow to {x, y + (screenHeight / 2)}
    set size of recentWindow to {screenWidth, screenHeight / 2}
end tell
